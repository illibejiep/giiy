 ...
 *
 * @property VideoTypeEnum $type
 */
abstract class BaseVideo extends GiiyActiveRecord implements ITypeEnumerable {
                /** @var VideoTypeEnum */
        protected $_type;
    ...
    public function getType() {
        ...
        if ($this->_type === null)
            $this->_type = new VideoTypeEnum($this->getAttribute('type_enum'));

        return $this->_type;
    }

    public function setType($value) {
        if ($value instanceof VideoTypeEnum) {
            $this->_type = $value;
            $this->setAttribute('type_enum', $value->id);
        } elseif (is_numeric($value)) {
            $this->_type = new VideoTypeEnum($value);
    ...
    {
        $typesFields = array();
        foreach (VideoTypeEnum::$names as $id => $name) {
